package com.codingpearls.springbootwithmultipledatasource.config;
...
@EnableJpaRepositories(
  ...
  basePackages = { "com.codingpearls.springbootwithmultipledatasource.accountdb.repository" }
)
public class AccountDataSourceConfig {
	...
	public LocalContainerEntityManagerFactoryBean accountEntityManagerFactory(EntityManagerFactoryBuilder builder,
		...
		return builder
				...
				.packages("com.codingpearls.springbootwithmultipledatasource.accountdb.entity")
				.build();
	}
